// src/pages/AppPreferences.jsx
//
// App-level preferences (units, language, notifications, account, appearance,
// danger zone). This was the previous /settings page; it moved here when
// /settings became the device comfort & configuration screen.
...
export default function AppPreferences() {
  ...
  const handleDangerAction = (action) => {
    if (window.confirm(`⚠️ WARNING: Are you sure you want to trigger this action: "${action}"? This cannot be undone.`)) {
      notify.success(`${action} triggered`, { message: "The device will apply it on next sync." });
    }
  };
